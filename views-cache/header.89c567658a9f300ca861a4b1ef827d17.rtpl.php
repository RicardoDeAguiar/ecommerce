...
<head>
  ...
  <title>Administrador | Starter</title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="/res/admin/dist/img/user6-128x128.jpg" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs">Ricardo Aguiar </span>
            </a>
            <ul class="dropdown-menu">
              <!-- The user image in the menu -->
              <li class="user-header">
                <img src="/res/admin/dist/img/user6-128x128.jpg" class="img-circle" alt="User Image">

                <p>
                  Ricardo Aguiar - Desenvolvedor Web
                  <small>Menbro desde Nov. 2017</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
