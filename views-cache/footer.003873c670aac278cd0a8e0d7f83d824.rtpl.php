            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2>Ricardo Store</h2>
                        <p> A empresa (nome da empresa) foi fundada no ano de (ano da fundação, por exemplo, 1998) na cidade (nome da cidade) pelo Senhor (nome do fundador) e sua principal missão é oferecer soluções para empresas de e-commerce e Internet. Atualmente contamos com XX funcionários e nossos principais clientes são (coloque aqui o que sua empresa vende ou oferece). </p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-newsletter">
                        ...
                        <p>Os preços e condições de pagamento divulgados no site da Ricardo Store, são exclusivos para compras através deste, não valendo necessariamente para a rede de lojas físicas e televendas. Se increva para receber nossas ofertas!</p>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; Ricardo Aguiar 2017. <a href="www.ecommerce.com.br" target="_blank">FEMA 2017</a></p>
                    </div>
                </div>
