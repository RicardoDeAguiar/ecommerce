<?php if(!class_exists('Rain\Tpl')){exit;}?><!-- Main Footer -->
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>direito autoral &copy; 2017 <a href="#">Ricardo Store</a>.</strong> Todos direitos reservados.
  </footer>
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript:;">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Aniversário de Fulano</h4>

                <p>Fará 23 anos dia 30 de fevereiro</p>
              </div>
            </a>
          </li>
        </ul>
